<?php dump( $this->themeurl); ?>
   <header class="noprint header">
      <nav class="navbar navbar-static-top navbar-fixed-top" role="navigation">
         <a href="/" class="logo">
         <img   src="<?= $this->server->root.$this->themeurl ?>/img/mongkollogo.png" alt="dsla" class="img-responsive" style="margin:auto;width:80px;height:50px;background-color:white">
         </a>
         <div>
